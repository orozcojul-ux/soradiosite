...
export default function Home() {
  ...
  // Afficher un loader si les paramètres ne sont pas encore chargés
  if (!settings) {
    return (
        ...
        <div className="relative container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-[`Pacifico`] text-white drop-shadow-lg">{settings.general.name.split(' - ')[0] || 'SORadio'}</h1>
                <p className="text-orange-300 text-sm font-medium">{settings.general.slogan}</p>
              </div>
            </div>

            {/* Navigation Desktop */}
            <nav className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-white hover:text-orange-300 transition-colors cursor-pointer font-medium">Accueil</Link>
              ...
              <Link href="/equipe" className="text-white hover:text-orange-300 transition-colors cursor-pointer font-medium">Équipe</Link>
              <Link href="/contact" className="text-white hover:text-orange-300 transition-colors cursor-pointer font-medium">Contact</Link>
            </nav>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-6 bg-black/20 backdrop-blur-md rounded-xl border border-white/20">
              <div className="p-4 space-y-2">
                <Link href="/" className="block px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-colors cursor-pointer">Accueil</Link>
                <Link href="/programmes" className="block px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-colors cursor-pointer">Programmes</Link>
                <Link href="/podcasts" className="block px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-colors cursor-pointer">Podcasts</Link>
                <Link href="/equipe" className="block px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-colors cursor-pointer">Équipe</Link>
                <Link href="/contact" className="block px-4 py-3 text-white hover:bg-white/10 rounded-lg transition-colors cursor-pointer">Contact</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500"> depuis Bordeaux</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Découvrez {settings.general.name.split(' - ')[0]}, la station qui fait vibrer le Sud-Ouest. Musique, actualités locales et programmes exclusifs, 24h/24.
              </p>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-8 mb-8 border border-orange-200">
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-orange-600 font-medium">Morning Show • Sophie & Marc</p>
                    <p className="text-gray-500 text-sm">{settings.general.frequency} • soradio.fr</p>
                  </div>
                </div>
                {isPlaying && (
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link href="/programmes" className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-xl font-semibold hover:scale-105 transition-transform cursor-pointer whitespace-nowrap text-center shadow-lg">
                  Nos Programmes
                </Link>
                <Link href="/podcasts" className="border-2 border-orange-500 text-orange-600 px-8 py-4 rounded-xl font-semibold hover:bg-orange-500 hover:text-white transition-colors cursor-pointer whitespace-nowrap text-center">
                  Podcasts
                </Link>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Réveillez-vous en douceur avec Sophie et Marc. Actualités, météo, musique et bonne humeur pour bien commencer la journée.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Les meilleurs hits et découvertes musicales. Pop, rock, électro... la playlist parfaite pour votre après-midi.
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Ambiance nocturne avec des sons électroniques et alternatifs. Pour les noctambules et les amateurs de découvertes.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-8">
                Depuis le cœur de 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500"> Bordeaux</span>
              </h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                SORadio est née de la passion pour la musique et la culture bordelaise. Nous diffusons 24h/24 depuis nos studios du centre-ville, en proposant une programmation éclectique qui mélange talents locaux et hits internationaux.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-red-500">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Ne manquez aucune de nos émissions et participez à la vie de votre radio préférée
          </p>
      ...
      <footer className="bg-gray-800 py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-[`Pacifico`] text-white">{settings.general.name.split(' - ')[0]}</h3>
                  <p className="text-orange-400 text-sm">{settings.general.name.split(' - ')[1] || 'Sud Ouest Radio'}</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center space-x-2">
                  ...
                  <span>{settings.general.address.split(',')[1]?.trim() || 'Bordeaux'}, France</span>
                </li>
                <li className="flex items-center space-x-2">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-400">&copy; 2024 {settings.general.name.split(' - ')[0]} - {settings.general.name.split(' - ')[1]}. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
