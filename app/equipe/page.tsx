        ...
        <div className="relative container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/equipe" className="text-orange-300 font-medium cursor-pointer">
                Équipe
              </Link>
              ...
              <div key={member.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 group">
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      className={`bg-gradient-to-r ${departments.find((d) => d.key === member.department)?.color ||
                        'from-gray-500 to-gray-600'} text-white px-3 py-1 rounded-full text-sm font-medium`}
                    >
